...
@section('content')
    <div class="max-w-2xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-xl font-bold text-text-main">Tambah Pupuk</h2>
                <p class="text-text-secondary text-sm">Tambah data pupuk baru</p>
            </div>
            ...
            <form action="{{ route('admin.fertilizers.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price_per_kg" value="{{ old('price_per_kg') }}" required
