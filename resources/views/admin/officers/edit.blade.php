...
@php $pageTitle = 'Edit Petugas'; @endphp
...
@section('content')
    <div class="max-w-2xl">
        ...
        <div class="bg-white p-6 rounded-xl border border-surface-border shadow-sm">
            <h2 class="text-lg font-bold text-text-main mb-6">Form Edit Petugas</h2>
            
            <form action="{{ route('admin.officers.update', $officer) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
